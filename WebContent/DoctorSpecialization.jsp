...
<body>
	...
	try {
		...
		String sql = "Select * from specialization where doctorname ='" + doctor_name + "'";
		ResultSet rs = st.executeQuery(sql);
	%>
	<section class="my-5">
		<div class="py-5">
			<h2 class="text-center">My Specializations</h2>
		</div>
	...
	<section>
	<div class="container">
		<a href="AddSpecialization.jsp" class="btn btn-success">Add
			Specialization</a>
	</div>
	</section>
	<br>
