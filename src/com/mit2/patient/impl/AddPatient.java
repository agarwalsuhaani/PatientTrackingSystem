...
public class AddPatient extends HttpServlet{
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
	{
		...
		try
		{
			...
			{
				PreparedStatement st=conn.prepareStatement("insert into `patient`(patientname,patientaddress,patientcontact,patientemail,img) values(?,?,?,?,?)");
